...
\begin{document}
	...
	\section{Ejercicio 1}
	\input{Ejercicio1.tex} % Primer ejercicio

	\section{Ejercicio 2}
	\input{Ejercicio2.tex} % Segundo ejercicio

	\section{Ejercicio 3}
	\input{Ejercicio3.tex} % Tercer ejercicio

	\section{Ejercicio 4}
	\input{Ejercicio4.tex} % Cuarto ejercicio

	\section{Ejercicio 5}
	\input{Ejercicio5.tex} % Quinto ejercicio

	\section{Ejercicio 6}
	\input{Ejercicio6.tex} % Sexto ejercicio

	\section{Ejercicio 7}
	\input{Ejercicio7.tex} % Séptimo ejercicio

	\section{Ejercicio 8}
	\input{Ejercicio8.tex} % Octavo ejercicio
\end{document}
